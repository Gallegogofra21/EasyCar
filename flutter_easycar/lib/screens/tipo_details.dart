...
class TipoDetailsPage extends StatefulWidget {
  const TipoDetailsPage({key}) : super(key: key);

  @override
  _TipoDetailsPageState createState() => _TipoDetailsPageState();
}

class _TipoDetailsPageState extends State<TipoDetailsPage> {
