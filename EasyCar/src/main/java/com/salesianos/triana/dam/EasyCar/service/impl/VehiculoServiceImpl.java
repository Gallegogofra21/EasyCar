...
public class VehiculoServiceImpl implements VehiculoService {
    ...
    @Override
    public Page<GetVehiculoDto> findAllVehiculosByTipo(@PathVariable Long id, Pageable pageable) {
        Page<Vehiculo> data = repository.findAllVehiculosByTipo(id, pageable);
    ...
    public GetVehiculoDto findById(Long id) {
        ...
        GetVehiculoDto result = GetVehiculoDto.builder()
                ...
                .foto2(vehiculo.getFoto2())
                .foto3(vehiculo.getFoto3())
                .foto4(vehiculo.getFoto4())
